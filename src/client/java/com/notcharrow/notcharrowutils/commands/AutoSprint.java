...
public class AutoSprint {
	...
	private static int execute(CommandContext<FabricClientCommandSource> context) {
		if (client.player != null) {
			if (!ConfigManager.config.tickregistryAutoSprint) {
				client.player.sendMessage(TextFormat.styledText("Autosprint enabled."), false);
			} else {
				client.player.sendMessage(TextFormat.styledText("Autosprint disabled."), false);
			}
		}
